  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        circulardark: "repeating-radial-gradient(rgba(255, 255, 255, 0.4) 3px, #1b1b1b 10px, #1b1b1b 100px);",
        circularLightlg: "repeating-radial-gradient(rgba(0, 0, 0, 0.4) 2px, #f5f5f5 5px, #f5f5f5 80px);",
        circulardarklg: "repeating-radial-gradient(rgba(255, 255, 255, 0.4) 3px, #1b1b1b 10px, #1b1b1b 80px);",
